...
from tests.test_utils import MockClient429, MockTechClient, RateLimitReached, create_parquet_files
...
def test_handles_429_and_stops_safely(tmp_path):
    ...
    create_parquet_files(input_path, num_files=1, rows_per_file=10)
